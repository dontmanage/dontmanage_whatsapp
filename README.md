...
WhatsApp integration for dontmanage. Use directly meta API's without any 3rd party integration.
...
```bench get-app https://github.com/shridarpatil/dontmanage_whatsapp```

### Step 2) to install app on any instance/site

```bench --site [sitename] install-app dontmanage_whatsapp```



### Send whatsapp notification from dontmanage app based on docevents.
...
- Setup webhook on meta
  ...
  * Add webhook url on meta `<your domain>/api/method/dontmanage_whatsapp.utils.webhook.webhook`
